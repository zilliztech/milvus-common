...
struct sherwood_v8_constants {
    ...
    inline static int
    distance_from_metadata(int8_t metadata) {
...
struct sherwood_v8_block {
    ...
    void
    fill_control_bytes(int8_t value) {
...
class sherwood_v8_table : private ByteAlloc, private Hasher, private Equal {
 ...
 public:
    ...
    sherwood_v8_table&
    operator=(const sherwood_v8_table& other) {
    ...
    sherwood_v8_table&
    operator=(sherwood_v8_table&& other) noexcept {
        if (this == std::addressof(other))
            return *this;
 ...
 private:
    ...
    void
    rehash_for_other_container(const sherwood_v8_table& other) {
    ...
    void
    swap_pointers(sherwood_v8_table& other) {
        using std::swap;
    ...
    struct LinkedListIt {
        ...
        void
        set_metadata(int8_t metadata) {
            block->control_bytes[index_in_block()] = metadata;
        }

        LinkedListIt
        next(sherwood_v8_table& table) const {
        ...
        bool
        operator==(const LinkedListIt& other) const {
    ...
    LinkedListIt
    find_direct_hit(LinkedListIt child) const {
    ...
    LinkedListIt
    find_parent_block(LinkedListIt child) {
    ...
    std::pair<int8_t, LinkedListIt>
    find_free_index(LinkedListIt parent) const {
    ...
    size_t
    calculate_memory_requirement(size_t num_blocks) {
    ...
    void
    deallocate_data(BlockPointer begin, size_t num_slots_minus_one) {
