// Taken from
// https://github.com/pytorch/pytorch/blob/ad507789d12e3f757a43f35cd66e7aea6124140d/c10/util/flat_hash_map.h
// - remove c10 relate macro
// - remove compiler warning handling
// Taken from
...
class sherwood_v3_table : private EntryAlloc, private DetailHasher, private Equal {
 ...
 public:
    ...
    void
    reserve(uint64_t num_elements_) {
 ...
 private:
    ...
    static int8_t
    compute_max_lookups(uint64_t num_buckets) {
...
struct prime_number_hash_policy {
    ...
    static uint64_t
    mod127(uint64_t hash) {
        return hash % 127llu;
    }
    static uint64_t
    mod151(uint64_t hash) {
        return hash % 151llu;
    }
    static uint64_t
    mod197(uint64_t hash) {
        return hash % 197llu;
    }
    static uint64_t
    mod251(uint64_t hash) {
        return hash % 251llu;
    }
    static uint64_t
    mod313(uint64_t hash) {
        return hash % 313llu;
    }
    static uint64_t
    mod397(uint64_t hash) {
        return hash % 397llu;
    }
    static uint64_t
    mod499(uint64_t hash) {
        return hash % 499llu;
    }
    static uint64_t
    mod631(uint64_t hash) {
        return hash % 631llu;
    }
    static uint64_t
    mod797(uint64_t hash) {
        return hash % 797llu;
    }
    static uint64_t
    mod1009(uint64_t hash) {
        return hash % 1009llu;
    }
    static uint64_t
    mod1259(uint64_t hash) {
        return hash % 1259llu;
    }
    static uint64_t
    mod1597(uint64_t hash) {
        return hash % 1597llu;
    }
    static uint64_t
    mod2011(uint64_t hash) {
        return hash % 2011llu;
    }
    static uint64_t
    mod2539(uint64_t hash) {
        return hash % 2539llu;
    }
    static uint64_t
    mod3203(uint64_t hash) {
        return hash % 3203llu;
    }
    static uint64_t
    mod4027(uint64_t hash) {
        return hash % 4027llu;
    }
    static uint64_t
    mod5087(uint64_t hash) {
        return hash % 5087llu;
    }
    static uint64_t
    mod6421(uint64_t hash) {
        return hash % 6421llu;
    }
    static uint64_t
    mod8089(uint64_t hash) {
        return hash % 8089llu;
    }
    static uint64_t
    mod10193(uint64_t hash) {
        return hash % 10193llu;
    }
    static uint64_t
    mod12853(uint64_t hash) {
        return hash % 12853llu;
    }
    static uint64_t
    mod16193(uint64_t hash) {
        return hash % 16193llu;
    }
    static uint64_t
    mod20399(uint64_t hash) {
        return hash % 20399llu;
    }
    static uint64_t
    mod25717(uint64_t hash) {
        return hash % 25717llu;
    }
    static uint64_t
    mod32401(uint64_t hash) {
        return hash % 32401llu;
    }
    static uint64_t
    mod40823(uint64_t hash) {
        return hash % 40823llu;
    }
    static uint64_t
    mod51437(uint64_t hash) {
        return hash % 51437llu;
    }
    static uint64_t
    mod64811(uint64_t hash) {
        return hash % 64811llu;
    }
    static uint64_t
    mod81649(uint64_t hash) {
        return hash % 81649llu;
    }
    static uint64_t
    mod102877(uint64_t hash) {
        return hash % 102877llu;
    }
    static uint64_t
    mod129607(uint64_t hash) {
        return hash % 129607llu;
    }
    static uint64_t
    mod163307(uint64_t hash) {
        return hash % 163307llu;
    }
    static uint64_t
    mod205759(uint64_t hash) {
        return hash % 205759llu;
    }
    static uint64_t
    mod259229(uint64_t hash) {
        return hash % 259229llu;
    }
    static uint64_t
    mod326617(uint64_t hash) {
        return hash % 326617llu;
    }
    static uint64_t
    mod411527(uint64_t hash) {
        return hash % 411527llu;
    }
    static uint64_t
    mod518509(uint64_t hash) {
        return hash % 518509llu;
    }
    static uint64_t
    mod653267(uint64_t hash) {
        return hash % 653267llu;
    }
    static uint64_t
    mod823117(uint64_t hash) {
        return hash % 823117llu;
    }
    static uint64_t
    mod1037059(uint64_t hash) {
        return hash % 1037059llu;
    }
    static uint64_t
    mod1306601(uint64_t hash) {
        return hash % 1306601llu;
    }
    static uint64_t
    mod1646237(uint64_t hash) {
        return hash % 1646237llu;
    }
    static uint64_t
    mod2074129(uint64_t hash) {
        return hash % 2074129llu;
    }
    static uint64_t
    mod2613229(uint64_t hash) {
        return hash % 2613229llu;
    }
    static uint64_t
    mod3292489(uint64_t hash) {
        return hash % 3292489llu;
    }
    static uint64_t
    mod4148279(uint64_t hash) {
        return hash % 4148279llu;
    }
    static uint64_t
    mod5226491(uint64_t hash) {
        return hash % 5226491llu;
    }
    static uint64_t
    mod6584983(uint64_t hash) {
        return hash % 6584983llu;
    }
    static uint64_t
    mod8296553(uint64_t hash) {
        return hash % 8296553llu;
    }
    static uint64_t
    mod10453007(uint64_t hash) {
        return hash % 10453007llu;
    }
    static uint64_t
    mod13169977(uint64_t hash) {
        return hash % 13169977llu;
    }
    static uint64_t
    mod16593127(uint64_t hash) {
        return hash % 16593127llu;
    }
    static uint64_t
    mod20906033(uint64_t hash) {
        return hash % 20906033llu;
    }
    static uint64_t
    mod26339969(uint64_t hash) {
        return hash % 26339969llu;
    }
    static uint64_t
    mod33186281(uint64_t hash) {
        return hash % 33186281llu;
    }
    static uint64_t
    mod41812097(uint64_t hash) {
        return hash % 41812097llu;
    }
    static uint64_t
    mod52679969(uint64_t hash) {
        return hash % 52679969llu;
    }
    static uint64_t
    mod66372617(uint64_t hash) {
        return hash % 66372617llu;
    }
    static uint64_t
    mod83624237(uint64_t hash) {
        return hash % 83624237llu;
    }
    static uint64_t
    mod105359939(uint64_t hash) {
        return hash % 105359939llu;
    }
    static uint64_t
    mod132745199(uint64_t hash) {
        return hash % 132745199llu;
    }
    static uint64_t
    mod167248483(uint64_t hash) {
        return hash % 167248483llu;
    }
    static uint64_t
    mod210719881(uint64_t hash) {
        return hash % 210719881llu;
    }
    static uint64_t
    mod265490441(uint64_t hash) {
        return hash % 265490441llu;
    }
    static uint64_t
    mod334496971(uint64_t hash) {
        return hash % 334496971llu;
    }
    static uint64_t
    mod421439783(uint64_t hash) {
        return hash % 421439783llu;
    }
    static uint64_t
    mod530980861(uint64_t hash) {
        return hash % 530980861llu;
    }
    static uint64_t
    mod668993977(uint64_t hash) {
        return hash % 668993977llu;
    }
    static uint64_t
    mod842879579(uint64_t hash) {
        return hash % 842879579llu;
    }
    static uint64_t
    mod1061961721(uint64_t hash) {
        return hash % 1061961721llu;
    }
    static uint64_t
    mod1337987929(uint64_t hash) {
        return hash % 1337987929llu;
    }
    static uint64_t
    mod1685759167(uint64_t hash) {
        return hash % 1685759167llu;
    }
    static uint64_t
    mod2123923447(uint64_t hash) {
        return hash % 2123923447llu;
    }
    static uint64_t
    mod2675975881(uint64_t hash) {
        return hash % 2675975881llu;
    }
    static uint64_t
    mod3371518343(uint64_t hash) {
        return hash % 3371518343llu;
    }
    static uint64_t
    mod4247846927(uint64_t hash) {
        return hash % 4247846927llu;
    }
    static uint64_t
    mod5351951779(uint64_t hash) {
        return hash % 5351951779llu;
    }
    static uint64_t
    mod6743036717(uint64_t hash) {
        return hash % 6743036717llu;
    }
    static uint64_t
    mod8495693897(uint64_t hash) {
        return hash % 8495693897llu;
    }
    static uint64_t
    mod10703903591(uint64_t hash) {
        return hash % 10703903591llu;
    }
    static uint64_t
    mod13486073473(uint64_t hash) {
        return hash % 13486073473llu;
    }
    static uint64_t
    mod16991387857(uint64_t hash) {
        return hash % 16991387857llu;
    }
    static uint64_t
    mod21407807219(uint64_t hash) {
        return hash % 21407807219llu;
    }
    static uint64_t
    mod26972146961(uint64_t hash) {
        return hash % 26972146961llu;
    }
    static uint64_t
    mod33982775741(uint64_t hash) {
        return hash % 33982775741llu;
    }
    static uint64_t
    mod42815614441(uint64_t hash) {
        return hash % 42815614441llu;
    }
    static uint64_t
    mod53944293929(uint64_t hash) {
        return hash % 53944293929llu;
    }
    static uint64_t
    mod67965551447(uint64_t hash) {
        return hash % 67965551447llu;
    }
    static uint64_t
    mod85631228929(uint64_t hash) {
        return hash % 85631228929llu;
    }
    static uint64_t
    mod107888587883(uint64_t hash) {
        return hash % 107888587883llu;
    }
    static uint64_t
    mod135931102921(uint64_t hash) {
        return hash % 135931102921llu;
    }
    static uint64_t
    mod171262457903(uint64_t hash) {
        return hash % 171262457903llu;
    }
    static uint64_t
    mod215777175787(uint64_t hash) {
        return hash % 215777175787llu;
    }
    static uint64_t
    mod271862205833(uint64_t hash) {
        return hash % 271862205833llu;
    }
    static uint64_t
    mod342524915839(uint64_t hash) {
        return hash % 342524915839llu;
    }
    static uint64_t
    mod431554351609(uint64_t hash) {
        return hash % 431554351609llu;
    }
    static uint64_t
    mod543724411781(uint64_t hash) {
        return hash % 543724411781llu;
    }
    static uint64_t
    mod685049831731(uint64_t hash) {
        return hash % 685049831731llu;
    }
    static uint64_t
    mod863108703229(uint64_t hash) {
        return hash % 863108703229llu;
    }
    static uint64_t
    mod1087448823553(uint64_t hash) {
        return hash % 1087448823553llu;
    }
    static uint64_t
    mod1370099663459(uint64_t hash) {
        return hash % 1370099663459llu;
    }
    static uint64_t
    mod1726217406467(uint64_t hash) {
        return hash % 1726217406467llu;
    }
    static uint64_t
    mod2174897647073(uint64_t hash) {
        return hash % 2174897647073llu;
    }
    static uint64_t
    mod2740199326961(uint64_t hash) {
        return hash % 2740199326961llu;
    }
    static uint64_t
    mod3452434812973(uint64_t hash) {
        return hash % 3452434812973llu;
    }
    static uint64_t
    mod4349795294267(uint64_t hash) {
        return hash % 4349795294267llu;
    }
    static uint64_t
    mod5480398654009(uint64_t hash) {
        return hash % 5480398654009llu;
    }
    static uint64_t
    mod6904869625999(uint64_t hash) {
        return hash % 6904869625999llu;
    }
    static uint64_t
    mod8699590588571(uint64_t hash) {
        return hash % 8699590588571llu;
    }
    static uint64_t
    mod10960797308051(uint64_t hash) {
        return hash % 10960797308051llu;
    }
    static uint64_t
    mod13809739252051(uint64_t hash) {
        return hash % 13809739252051llu;
    }
    static uint64_t
    mod17399181177241(uint64_t hash) {
        return hash % 17399181177241llu;
    }
    static uint64_t
    mod21921594616111(uint64_t hash) {
        return hash % 21921594616111llu;
    }
    static uint64_t
    mod27619478504183(uint64_t hash) {
        return hash % 27619478504183llu;
    }
    static uint64_t
    mod34798362354533(uint64_t hash) {
        return hash % 34798362354533llu;
    }
    static uint64_t
    mod43843189232363(uint64_t hash) {
        return hash % 43843189232363llu;
    }
    static uint64_t
    mod55238957008387(uint64_t hash) {
        return hash % 55238957008387llu;
    }
    static uint64_t
    mod69596724709081(uint64_t hash) {
        return hash % 69596724709081llu;
    }
    static uint64_t
    mod87686378464759(uint64_t hash) {
        return hash % 87686378464759llu;
    }
    static uint64_t
    mod110477914016779(uint64_t hash) {
        return hash % 110477914016779llu;
    }
    static uint64_t
    mod139193449418173(uint64_t hash) {
        return hash % 139193449418173llu;
    }
    static uint64_t
    mod175372756929481(uint64_t hash) {
        return hash % 175372756929481llu;
    }
    static uint64_t
    mod220955828033581(uint64_t hash) {
        return hash % 220955828033581llu;
    }
    static uint64_t
    mod278386898836457(uint64_t hash) {
        return hash % 278386898836457llu;
    }
    static uint64_t
    mod350745513859007(uint64_t hash) {
        return hash % 350745513859007llu;
    }
    static uint64_t
    mod441911656067171(uint64_t hash) {
        return hash % 441911656067171llu;
    }
    static uint64_t
    mod556773797672909(uint64_t hash) {
        return hash % 556773797672909llu;
    }
    static uint64_t
    mod701491027718027(uint64_t hash) {
        return hash % 701491027718027llu;
    }
    static uint64_t
    mod883823312134381(uint64_t hash) {
        return hash % 883823312134381llu;
    }
    static uint64_t
    mod1113547595345903(uint64_t hash) {
        return hash % 1113547595345903llu;
    }
    static uint64_t
    mod1402982055436147(uint64_t hash) {
        return hash % 1402982055436147llu;
    }
    static uint64_t
    mod1767646624268779(uint64_t hash) {
        return hash % 1767646624268779llu;
    }
    static uint64_t
    mod2227095190691797(uint64_t hash) {
        return hash % 2227095190691797llu;
    }
    static uint64_t
    mod2805964110872297(uint64_t hash) {
        return hash % 2805964110872297llu;
    }
    static uint64_t
    mod3535293248537579(uint64_t hash) {
        return hash % 3535293248537579llu;
    }
    static uint64_t
    mod4454190381383713(uint64_t hash) {
        return hash % 4454190381383713llu;
    }
    static uint64_t
    mod5611928221744609(uint64_t hash) {
        return hash % 5611928221744609llu;
    }
    static uint64_t
    mod7070586497075177(uint64_t hash) {
        return hash % 7070586497075177llu;
    }
    static uint64_t
    mod8908380762767489(uint64_t hash) {
        return hash % 8908380762767489llu;
    }
    static uint64_t
    mod11223856443489329(uint64_t hash) {
        return hash % 11223856443489329llu;
    }
    static uint64_t
    mod14141172994150357(uint64_t hash) {
        return hash % 14141172994150357llu;
    }
    static uint64_t
    mod17816761525534927(uint64_t hash) {
        return hash % 17816761525534927llu;
    }
    static uint64_t
    mod22447712886978529(uint64_t hash) {
        return hash % 22447712886978529llu;
    }
    static uint64_t
    mod28282345988300791(uint64_t hash) {
        return hash % 28282345988300791llu;
    }
    static uint64_t
    mod35633523051069991(uint64_t hash) {
        return hash % 35633523051069991llu;
    }
    static uint64_t
    mod44895425773957261(uint64_t hash) {
        return hash % 44895425773957261llu;
    }
    static uint64_t
    mod56564691976601587(uint64_t hash) {
        return hash % 56564691976601587llu;
    }
    static uint64_t
    mod71267046102139967(uint64_t hash) {
        return hash % 71267046102139967llu;
    }
    static uint64_t
    mod89790851547914507(uint64_t hash) {
        return hash % 89790851547914507llu;
    }
    static uint64_t
    mod113129383953203213(uint64_t hash) {
        return hash % 113129383953203213llu;
    }
    static uint64_t
    mod142534092204280003(uint64_t hash) {
        return hash % 142534092204280003llu;
    }
    static uint64_t
    mod179581703095829107(uint64_t hash) {
        return hash % 179581703095829107llu;
    }
    static uint64_t
    mod226258767906406483(uint64_t hash) {
        return hash % 226258767906406483llu;
    }
    static uint64_t
    mod285068184408560057(uint64_t hash) {
        return hash % 285068184408560057llu;
    }
    static uint64_t
    mod359163406191658253(uint64_t hash) {
        return hash % 359163406191658253llu;
    }
    static uint64_t
    mod452517535812813007(uint64_t hash) {
        return hash % 452517535812813007llu;
    }
    static uint64_t
    mod570136368817120201(uint64_t hash) {
        return hash % 570136368817120201llu;
    }
    static uint64_t
    mod718326812383316683(uint64_t hash) {
        return hash % 718326812383316683llu;
    }
    static uint64_t
    mod905035071625626043(uint64_t hash) {
        return hash % 905035071625626043llu;
    }
    static uint64_t
    mod1140272737634240411(uint64_t hash) {
        return hash % 1140272737634240411llu;
    }
    static uint64_t
    mod1436653624766633509(uint64_t hash) {
        return hash % 1436653624766633509llu;
    }
    static uint64_t
    mod1810070143251252131(uint64_t hash) {
        return hash % 1810070143251252131llu;
    }
    static uint64_t
    mod2280545475268481167(uint64_t hash) {
        return hash % 2280545475268481167llu;
    }
    static uint64_t
    mod2873307249533267101(uint64_t hash) {
        return hash % 2873307249533267101llu;
    }
    static uint64_t
    mod3620140286502504283(uint64_t hash) {
        return hash % 3620140286502504283llu;
    }
    static uint64_t
    mod4561090950536962147(uint64_t hash) {
        return hash % 4561090950536962147llu;
    }
    static uint64_t
    mod5746614499066534157(uint64_t hash) {
        return hash % 5746614499066534157llu;
    }
    static uint64_t
    mod7240280573005008577(uint64_t hash) {
        return hash % 7240280573005008577llu;
    }
    static uint64_t
    mod9122181901073924329(uint64_t hash) {
        return hash % 9122181901073924329llu;
    }
    static uint64_t
    mod11493228998133068689(uint64_t hash) {
        return hash % 11493228998133068689llu;
    }
    static uint64_t
    mod14480561146010017169(uint64_t hash) {
        return hash % 14480561146010017169llu;
    }
    static uint64_t
    mod18446744073709551557(uint64_t hash) {
    ...
    mod_function
    next_size_over(uint64_t& size) const {
    ...
    uint64_t
    index_for_hash(uint64_t hash, uint64_t /*num_slots_minus_one*/) const {
